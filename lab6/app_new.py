...
class BankApp:
    ...
    def clients(self):
        ...
        html += """
            ...
            <br><a href='/'>Назад</a>
            <br><a href='/transaction_add'>Добавить транзакцию</a>
        </body>
        </html>
        """
        return html
    ...
    def client(self, id):
        try:
            ...
            for trans in client.transactions:
                html += f"<li>{trans.date_time_str} - {trans.transaction_type} (<a href='/transaction_edit/{trans.id}'>Редактировать</a>)</li>"
            html += """
                </ul>
    ...
    def transaction_edit(self, id, **kwargs):
        try:
            ...
            <body>
                ...
                <form action="/transaction_edit/{id}" method="POST">
                    <label for="client_id">Клиент:</label>
                    <select name="client_id" id="client_id">
            """
            for client in clients:
